...
/**
 * \file    test/phpunit/RevenueCompareFunctionalTest.php
...
/**
 * Class RevenueCompareFunctionalTest
 *
 ...
 *
 * @package Testrevenuecompare
 */
class RevenueCompareFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modRevenueCompare')->click();
		} else {
			// Disable the module
			$this->byHref('modRevenueCompare')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/revenuecompare/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('revenuecompare/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/revenuecompare/admin/about.php');
		$this->authenticate();
		return $this->assertContains('revenuecompare/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('revenuecomparewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modRevenueCompare_RevenueCompareTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modRevenueCompare_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
